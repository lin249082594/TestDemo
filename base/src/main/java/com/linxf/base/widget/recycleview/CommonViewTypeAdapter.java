...
public abstract class CommonViewTypeAdapter<T>  extends  RecyclerView.Adapter<ViewHolder> {
    protected Context mContext;
    protected SparseArray<Integer> mLayoutIds;
    ...
    public CommonViewTypeAdapter setOnItemClickListener(OnItemClickListener onItemClickListener) {
    ...
    public CommonViewTypeAdapter(Context context, SparseArray<Integer> layoutId, List<T> datas) {
        mContext = context;
    ...
    public ViewHolder onCreateViewHolder(final ViewGroup parent, int viewType) {
        ViewHolder viewHolder = ViewHolder.get(mContext, null, parent, mLayoutIds.get(viewType), -1);
