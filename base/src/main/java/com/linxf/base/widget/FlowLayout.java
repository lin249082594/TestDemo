...
import com.linxf.base.constant.FlowView;
 ...
 * 搜索标签
 * 类详细说明.
 * Copyright: Copyright (c) 2018/4/28 17:35
 * Company: 北京宽连十方数字技术有限公司
 *
 * @author linxf (249082594@qq.com)
 * @version 1.0.0
 */
...
//        Log.i("test", "sizeHeight" + sizeHeight);
    ...
    public void setData(String[] strings) {
        ...
        for (int i = 0; i < count; i++) {
            final TextView tv = (TextView) mInflater.inflate(R.layout.flow_text_vew, this,
                    false);
